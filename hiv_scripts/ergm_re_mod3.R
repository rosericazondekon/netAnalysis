...
mnet3 <- read_graph('./graphs/HIVnet.graphml', format = 'graphml')
mnet.w <- read_graph('./graphs/HIVnet_weighted.graphml', format = 'graphml')
...
texreg(list(model1, model2, model3), single.row = TRUE,include.nobs = FALSE, 
       file = "ergm/ergm_hivaids-coauthNet5.tex",
       caption = "ERGM of the HIV/AIDS Co-authorship Network.",label = "tab:tergm"
