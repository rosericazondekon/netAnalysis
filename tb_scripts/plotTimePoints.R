...
plot(nt,layout =layout.kamada.kawai(nt),vertex.label=NA,edge.width = 0.5,main = '1996-2008',
...
plot(nt,layout =layout.kamada.kawai(nt),vertex.label=NA,edge.width = 0.5,main = '2009-2011',
     vertex.size=7+5 * sqrt(estimate_betweenness(nt,cutoff = 0)/1000),vertex.color=colr)
...
plot(nt,layout =layout.kamada.kawai(nt),vertex.label=NA,edge.width = 0.5,main = '2014-2015',
     vertex.size=7+5 * sqrt(estimate_betweenness(nt,cutoff = 0)/1000),vertex.color=colr)
