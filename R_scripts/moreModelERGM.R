...
save(model1, file = 'modData2/model1.rda')
...
#'
#+ formula2
model2.f <- formula(mnet3.simple ~ edges + nodecov("timesCited") + nodecov('degree') + nodecov("numPub") + 
                        nodematch("community") + nodematch("collabType") + nodefactor("community") + nodefactor("collabType"))
model2.f
...
save(model2, file = 'modData2/model2.rda')
...
#'
#+ formula3
model3.f <- formula(mnet3.simple ~ edges + triangle + nodecov("timesCited") + nodecov('degree') +
                        nodecov("numPub") + nodematch("community") + nodematch("collabType") + nodefactor("community"))
model3.f
...
mcmc.model3
save(mcmc.model3, file = "modData/mcmc-model3.rda")
#'
#+ save-mod3,cache=FALSE
save(model3, file = 'modData2/model3.rda')
...
#'
#+ formula4
model4.f <- formula(mnet3.simple ~ edges + triangle + nodecov("timesCited") + nodecov('degree') + nodecov("numPub") + 
                        nodematch("community") + nodematch("collabType") + nodefactor("community") + nodefactor("collabType"))
model4.f
...
mcmc.model4
save(mcmc.model4, file = "modData/mcmc-model4.rda")
#'
#+ save-mod4,cache=FALSE
save(model4, file = 'modData2/model4.rda')
...
Sys.time() - t0
save(diag.model1, file = 'modData2/diag.model1.rda')
jpeg(filename = './modData2/gof-model1.jpg')
plot(diag.model1)
dev.off()
...
Sys.time() - t0
save(diag.model2, file = 'modData2/diag.model2.rda')
jpeg(filename = './modData2/gof-model2.jpg')
plot(diag.model2)
dev.off()
...
Sys.time() - t0
save(diag.model3, file = 'modData2/diag.model3.rda')
jpeg(filename = './modData2/gof-model3.jpg')
plot(diag.model3)
dev.off()
...
Sys.time() - t0
save(diag.model4, file = 'modData2/diag.model4.rda')
jpeg(filename = './modData2/gof-model4.jpg')
plot(diag.model4)
dev.off()
#######################################################################################
#################################### END ##############################################
