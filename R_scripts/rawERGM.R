...
save(mod4, file = 'modData2/mod4.rda')
#'
#+ mod4-mcmc_diag,cache=FALSE
mcmc.mod4 <- mcmc.diagnostics(mod4)
#mcmc.mod4
save(mcmc.mod4, file = "modData2/mcmc-mod4.rda")
#'
#+ mod4-mcmc_diag_save
...
#mcmc.mod5
save(mcmc.mod5, file = "modData2/mcmc-mod5.rda")
#+ mod5-mcmc_diag_save
...
save(mod5, file = 'modData2/mod5.rda')

#' The new model, model 5 converges after {{mod3$iterations}}
#'  iterations. We can see that all terms are significant a
#' model likelihood of {{mod3$mle.lik}}
#' .
#' Let's see what this model does and does not capture about the structure in our original data.
...
save(sim2, file = 'modData2/sim2.rda')
...
save(mod6, file = 'modData2/mod6.rda')
#'
#+ mod6-mcmc_diag,cache=FALSE
mcmc.mod6 <- mcmc.diagnostics(mod6)
mcmc.mod6
save(mcmc.mod6, file = "modData2/mcmc-mod6.rda")
#'
...
save(sim3, file = 'modData2/sim3.rda')
...
Sys.time() - t0
jpeg(filename = './figure2/gof-mod6.jpg')
plot(diag.mod6)
dev.off()
mcmc.diagnostics(mod6)
#'
#+ save-diag-mod6,cache=FALSE
save(diag.mod6, file = "modData2/diag.mod6.rda")
