...
#'
#+ formula1
#model1.f <- formula(mnet3.simple ~ edges + triangle)
...
save(model1, file = 'modData3/smodel1.rda')
...
#'
#+ formula2
#model2.f <- formula(mnet3.simple ~ edges + gwesp(0, fixed = TRUE))
...
save(model2, file = 'modData3/smodel2.rda')
...
#'
#+ formula3
model3.f <- formula(mnet3.simple ~ edges + triangle)
model3.f
...
save(model3, file = 'modData3/smodel3.rda')
...
#'
#+ formula4
model4.f <- formula(mnet3.simple ~ edges + triangle + nodecov("timesCited") + nodecov('degree') 
                        + nodecov("numPub") + nodematch("communitySBM") + nodematch("collabType") 
...
save(model4, file = 'modData3/smodel4.rda')
...
Sys.time() - t0
save(diag.model2, file = 'modData3/diag.smodel2.rda')
jpeg(filename = './modData3/gof-smodel2.jpg')
par(mfrow=c(2,2))
plot(diag.model2)
dev.off()
...
Sys.time() - t0
save(diag.model4, file = 'modData3/diag.smodel4.rda')
jpeg(filename = './modData3/gof-smodel4.jpg')
par(mfrow=c(2,2))
plot(diag.model4)
dev.off()
